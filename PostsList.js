	...
	render() {
		...
		return (
			<div>
				...
				<Jumbotron>
					<h1 className="display-4">welcome to community</h1>
					<p className="lead">
						Here is the place where you can discuss and intract with people on your recipe
					</p>
					<hr className="my-2" />
					<p>
						If you haven't account, we recommend you to{' '}
